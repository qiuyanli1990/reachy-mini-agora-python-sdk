...
LOCAL_VISION_MODEL = _env("LOCAL_VISION_MODEL", "HuggingFaceTB/SmolVLM2-2.2B-Instruct")
HF_HOME = _env("HF_HOME", "./cache")
...
class VisionConfig:
    ...
    model_path: str = LOCAL_VISION_MODEL
...
class VisionProcessor:
    ...
    def initialize(self) -> bool:
        ...
        try:
            logger.info(f"Loading SmolVLM2 model on {self.device} (HF_HOME={HF_HOME})")
...
def initialize_vision_manager(camera_worker: Any) -> VisionManager | None:
    ...
    """
    try:
        model_id = LOCAL_VISION_MODEL
        cache_dir = os.path.expanduser(HF_HOME)
